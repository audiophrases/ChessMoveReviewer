@echo off
setlocal
title Chess Reviewer - yourlines suite
rem Chess Reviewer is part of the yourlines chess suite. Starting it here
...
echo     Review  http://localhost:5173/review/   ^<- opening this app
